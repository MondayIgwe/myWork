...
public class wordPressLogin {
	...
	public void loginToWprdPress(String username, String password) throws InterruptedException//Test case
	...
	Assert.assertEquals(driver.getTitle().contains("Dashbord"),"User not able to login","invalid Credentials");
